...
export const ItineraryTab: React.FC<ItineraryTabProps> = ({
  ...
  return <div>
      ...
      {view === "list" ? <ItineraryDayList tripDays={tripDays} onEditDay={onEditDay} onEditActivity={onEditActivity} onViewMap={handleViewMap} /> : <ItineraryTabView tripDays={tripDays} onEditDay={onEditDay} onEditActivity={onEditActivity} onViewMap={handleViewMap} />}
    </div>;
};