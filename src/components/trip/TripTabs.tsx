...
export const TripTabs: React.FC = () => {
  return <TabsList className="grid w-full grid-cols-6 mb-6 mx-[3px] my-px py-[3px] px-[23px] rounded-2xl bg-orange-400">
      ...
      <TabsTrigger value="cityview" className="font-futura text-base tracking-wide uppercase text-slate-100 bg-orange-600 hover:bg-orange-500">City View</TabsTrigger>
      <TabsTrigger value="translation" className="font-futura text-base tracking-wide uppercase text-slate-100 bg-orange-600 hover:bg-orange-500">Translation</TabsTrigger>
    </TabsList>;
};
