...
const DateProgress: React.FC<DateProgressProps> = ({ days }) => {
  ...
  return (
    <div className="my-8 sm:my-12 max-w-4xl mx-auto px-4">
      <div className="flex justify-between text-xs uppercase mb-2 text-white/80 tracking-wider">
        <span>June 5</span>
        <span>June 26</span>
      </div>
      <div className="h-1 bg-white/20 rounded-full" role="progressbar" aria-valuenow={days} aria-valuemin={0} aria-valuemax={21} aria-label={`Trip planning progress: ${days} of 21 days planned`}>
        <div 
