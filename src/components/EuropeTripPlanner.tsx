...
export const EuropeTripPlanner: React.FC = () => {
  ...
  return <div className="container mx-auto py-4 sm:py-8 space-y-4 sm:space-y-6 bg-slate-800 min-h-screen px-3 sm:px-4">
      {/* Trip Header */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0">
        <div className="w-full sm:w-auto py-[29px] px-0 my-0 mx-[36px]">
      ...
      <Tabs defaultValue="itinerary" className="w-full">
        ...
        <TripTabsContent tripDays={tripDays} onEditDay={handleEditDay} onEditActivity={handleEditActivity} onDeleteActivity={handleDeleteActivity} onCreateActivity={handleCreateActivity} />
      </Tabs>
