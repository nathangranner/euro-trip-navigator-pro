  ...
  return <div className="relative min-h-screen overflow-hidden bg-black text-white font-body">
      ...
      <div className="relative z-20 container mx-auto px-4 min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col justify-center items-center text-center my-8 md:my-24 pt-20">
          ...
          }} className="text-4xl sm:text-6xl font-light font-heading uppercase tracking-widest text-white mx-px md:text-6xl">
              EUROTRIP<span className="font-thin">25</span>
            </h1>
            
            <p className="max-w-xl mx-auto text-base sm:text-lg font-light tracking-wide text-white/90 leading-relaxed px-4 md:text-base">
              Your exclusive journey through Europe's most coveted destinations. 
              An experience designed for Jamie and Nathan.
            </p>

            {/* Primary CTA Button */}
            <button onClick={scrollToItinerary} aria-label="Navigate to trip itinerary planner" className="inline-block hover:bg-gold-dark px-6 sm:px-8 py-3 sm:py-4 uppercase tracking-wide font-medium transition-colors duration-200 text-white mt-6 sm:mt-8 text-sm sm:text-base rounded-none bg-amber-700 hover:bg-amber-600">
              Start Your Journey
            </button>
          </div>
